...
class CORE_EXPORT Cosmos final : public CosmosXobj,
 ...
 public:
  ...
  map<int64_t, CosmosNode*> m_mapWebRTNodeforEvent;
  map<int64_t, CosmosWinform*> m_mapWebRTWinformforEvent;
  map<int64_t, CosmosControl*> m_mapWebRTControlforEvent;
  map<wstring, CosmosGalaxy*> m_mapWebRTGalaxy2;
