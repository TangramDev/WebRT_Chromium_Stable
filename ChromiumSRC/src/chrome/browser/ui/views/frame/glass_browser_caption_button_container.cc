...
GlassBrowserCaptionButtonContainer::GlassBrowserCaptionButtonContainer(
	...
	// begin Add by TangramTeam
	if (::GetWindowLongPtr(views::HWNDForWidget(frame_view_->frame()),
		GWL_STYLE) &
		WS_CHILD) {
		frame_view_->m_bChild = true;
	}
	else
	{
